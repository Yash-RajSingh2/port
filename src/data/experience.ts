...
export const experiences: ExperienceData[] = [
  {
    ...
    imageSrc: "https://impactanalytics.com/wp-content/uploads/2023/03/Impact-Analytics-Logo-1.png",
    description: [
  ...
  },
  {
    ...
    imageSrc: "https://impactanalytics.com/wp-content/uploads/2023/03/Impact-Analytics-Logo-1.png",
    description: [
      "Engineered components to enhance the functionality and user experience of the application.",
      "Successfully implemented user interface designs utilizing MUI and ag-Grid, ensuring a seamless user experience."
    ]
  },
  {
    company: "SwitchLabs",
    ...
    imageSrc: "https://impactanalytics.com/wp-content/uploads/2023/03/Impact-Analytics-Logo-1.png",
    description: [
      "Structured the existing code for the product and built an analytics system to monitor traffic on the website.",
      "Revamped overall look of the company's website and rebuilt it."
    ]
  },
  {
    ...
    imageSrc: "",
    description: [
      "Mentoring the web dev team and overseeing the team projects."
    ]
  },
  {
    company: "ACE- Association for Computer Enthusiasts",
    ...
    imageSrc: "",
    description: [
      "Conducting events as a part of the society and built projects as a part of the Web development and cyber security."
    ]
  }
]; 